...
<div class="content mnya-5 mb-0">
    <div class="row mx-0 mt5">
        <div class="col-9 pl-0"<?php echo (session('kode-paket') == '1') ? ' style="padding-bottom: 35px;"' : ''; ?>>
            <div class="row bg-primary border-20 <?php echo (session('kode-paket') == '1') ? 'h-100 ' : ''; ?>mx-0 px5 py5">
            ...
            <div class="row mx-0 mt5 px5 py-3" style="background-color: #12336D; border-radius: 15px 15px 0 0;<?php echo (session('kode-paket') == '1') ? ' visibility: hidden;' : ''; ?>">
    ...
    <?php if (session('kode-paket') != '1') { ?>
        <div id="total-kelas" class="row mx-0 px5 py5" style="background-image: linear-gradient(113deg, #0095ec, #005ccb); border-radius: 0 20px 20px 20px;">
    ...
    <?php } else { ?>
        <div id="total-kelas" class="row border-20 mx-0 px5 py5" style="background-color: #262626">
            <div class="col 10">
                <div class="row mx-0">
                    <div class="col-3">
                        <div class="row justify-content-center align-content-center h-100 mx-0">
    ...
    <div class="row border-20 shadow mx-0 px5 py5">
        <div class="col-8 pl-0">
            ...
            <div class="row shadow mx-0 p-3" style="<?php echo (session('kode-paket') == '1') ? 'background-color: #262626; ' : ''; ?>min-height: 40%; border-radius: 0 15px 15px 15px; overflow-x: auto;">
                <div id="zoom-meeting" class="carousel slide w-100" data-ride="carousel" data-interval="false" data-pause="hover">
                    ...
                    <div class="carousel-inner h-100">
                            ...
                            for ($i=0; $i<sizeof($zoomMeeting); $i++) { ?>
                                <div class="carousel-item<?php echo ($i==0) ? ' active' : ''; ?>">
                                    <div class="row mx-0 h-100">
                                        <div class="col-6">
                                            <div class="row mx-0 h-100">
                                                <div class="col-4 bg-primary px-0" style="border-radius: 15px;"></div>
                                                <div class="col-8">
                        ...
                        <?php }
                        } elseif (session('kode-paket') != '1') { ?>
                            <div class="carousel-item h-100 active">
                                <div class="row justify-content-center align-content-center h-100 mx-0">
                                    <h5 class="font-weight-bold mb-0" style="color: #12336D;">Belum ada jadwal kelas selanjutnya</h5>
                                </div>
                            </div>
                        <?php } else { ?>
                            <div class="carousel-item h-100 active">
        ...
        <div class="col-4 mh-100 pr-0" style="padding-bottom: 35px;">
            ...
            <div class="row shadow h-100 mh-100 mx-0 p-3" style="min-height: 425px; max-height: 450px; background-image: linear-gradient(180deg, #0091e6, #005ccb); border-radius: 0 15px 15px 15px;">
                <div class="col-12 px-0" style="max-height: 425px; overflow-y: auto;">
                    <?php if (!empty($kuisHarian)) {
                        for ($i=0; $i<sizeof($kuisHarian); $i++) { ?>
                            <div class="row mx-0 mt-2">
                                <div class="col-4 bg-white px-0" style="border-radius: 15px;"></div>
                                <div class="col-8">
    ...
    <div class="row mt5 mx-0">
        <div class="col-3" style="padding-left: 0;">
            <div class="row justify-content-center border-20 shadow mx-0 px5 py5">
                ...
                <a href="<?= base_url() ?>/kelasku/view_pdf/ebook.pdf" class="btn h5 text-white mt-2 mb-0 px-3 py-1" style="background-color: #12336D; border-radius: 10px;">Lihat Selengkapnya</a>
            </div>
        </div>
        <div class="col-9" id="latsol" style="padding-right: 0;">
            <div class="row border-20 shadow h-100 mx-0 px5 py5" style="background-image: linear-gradient(113deg, #0095ec, #005ccb);">
                ...
                <div class="form-group w-100">
                    <select class="form-control form-control-sm w-25 mx-auto" id="latihan-bawah">
                        <option value="" disabled selected hidden><b>Pilihan materi</b></option>
                        <?php foreach ($materis as $materi) : ?>
                            <option value="<?= $materi['materi'] ?>"><?= $materi['materi'] ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div id="kotak-paket" class="col-4 px-0" style="visibility: hidden;">
                    <div class="row mx-0">
                        <div class="col-6 pl-0 pr-1">
                            <a id="paket1" href="#" class="btn btn-light w-100 mx-0 py5" style="border-radius: 10px;">
                                <h5 class="font-weight-bold mb-0" style="color: #12336D;">Paket 1</h5>
                            </a>
                        </div>
                        <div class="col-6 pr-0 pl-1">
                            <a id="paket2" href="#" class="btn btn-light w-100 mx-0 py5" style="border-radius: 10px;">
                    ...
                    <div class="row mx-0 mt-2">
                        <div class="col-6 pl-0 pr-1">
                            <a id="paket3" href="#" class="btn btn-light w-100 mx-0 py5" style="border-radius: 10px;">
                                <h5 class="font-weight-bold mb-0" style="color: #12336D;">Paket 3</h5>
                            </a>
                        </div>
                        <div class="col-6 pr-0 pl-1">
                            <a id="paket4" href="#" class="btn btn-light w-100 mx-0 py5" style="border-radius: 10px;">
                                <h5 class="font-weight-bold mb-0" style="color: #12336D;">Paket 4</h5>
                            </a>
                        </div>
                    </div>
                    <button class="btn btn-warning w-100 mx-0 mt-2 py-1" style="border-radius: 10px;" onclick="showModal();">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row mx-0">
                        <img id="paket5" src="" alt="" class="img-fluid border border-light rounded">
                    </div>
                </div>
    ...
    <script>
        document.getElementById('latihan-bawah').addEventListener('change', function() {
            ...
            document.getElementById('paket5').src="<?= base_url() ?>/img/Mind Map/"+materi+".jpg";
        });
